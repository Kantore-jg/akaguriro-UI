...
<template>
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-8">
    <!-- Header -->
    <div class="space-y-2">
      <h3 class="text-xs font-bold uppercase tracking-wider text-emerald-600">Plateforme Nationale</h3>
    ...
    <div class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between">
      ...
      <!-- Search -->
      <div class="w-full md:w-96 flex items-center gap-2 px-3 py-2 bg-slate-50 border border-slate-200/60 rounded-xl focus-within:border-emerald-300 focus-within:bg-white transition-all">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        ...
        <div class="w-full md:w-44 h-40 rounded-2xl overflow-hidden shrink-0 relative bg-slate-50">
          <img
            :src="m.image"
            :alt="m.name"
        ...
        <div class="flex-1 flex flex-col justify-between space-y-4">
          <div class="space-y-1.5">
            <h2 class="text-base sm:text-lg font-extrabold text-slate-900 group-hover:text-emerald-600 transition-colors">
              {{ m.name }}
            </h2>
            ...
            <div class="space-y-1.5 border-t border-slate-50 pt-3">
              ...
              <div class="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                <div
                  ...
                  :class="Math.round((m.occupiedPlaces / m.totalPlaces) * 100) > 80 ? 'bg-amber-500' : 'bg-emerald-500'"
